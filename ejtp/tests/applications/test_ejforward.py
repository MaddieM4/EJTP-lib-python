...
class TestClient(TestCaseWithLog):
    ...
    def setUp(self):
        ...
        self.listen(client_logger)
        self.listen(server_logger)
    ...
    def test_server_store_message_and_retrieve(self):
        ...
        self.assertInLog('WARNING:ejtp.applications.ejforward.client: Invalid frame, discarding')
    ...
    def test_upload(self):
        ...
        self.assertInLog("WARNING:ejtp.applications.ejforward.server: Unknown message type")
